...
namespace Hcbbook
{
    ...
    public class Hcbbook_ThemeContainer : ContainerControl
    {
    ...
    class Hcbbook_ControlBox : Control
    {
    ...
    public class Hcbbook_Button : Control
    {
    ...
    public class Hcbbook_SocialButton : Control
    {
    ...
    public class Hcbbook_Label : Label
    {

        public Hcbbook_Label()
        {
            Font = new Font("Segoe UI", 9);
    ...
    #endregion
    #region  Link Label
    public class Hcbbook_LinkLabel : LinkLabel
    {

        public Hcbbook_LinkLabel()
        {
    ...
    public class Hcbbook_HeaderLabel : Label
    {

        public Hcbbook_HeaderLabel()
        {
    ...
    public class Hcbbook_Toggle : Control
    {
    ...
    public class Hcbbook_CheckBox : Control
    {
    ...
    [DefaultEvent("CheckedChanged")]
    public class Hcbbook_RadioButton : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (_Control != this && _Control is Hcbbook_RadioButton)
                {
                    ((Hcbbook_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    public class Hcbbook_TextBox : Control
    {

        #region  Variables

        public TextBox HcbbookTB = new TextBox();
        ...
        public bool UseSystemPasswordChar
        {
            ...
            set
            {
                HcbbookTB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (HcbbookTB != null)
                {
                    HcbbookTB.Multiline = value;

                    if (value)
                    {
                        HcbbookTB.Height = Height - 23;
                    }
                    else
                    {
                        Height = HcbbookTB.Height + 23;
                    }
                }
            }
        }
        ...
        public Image Image
        {
            ...
            set
            {
                ...
                if (Image == null)
                {
                    HcbbookTB.Location = new Point(8, 10);
                }
                else
                {
                    HcbbookTB.Location = new Point(35, 11);
                }
                Invalidate();
            }
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (_Multiline)
            {
                HcbbookTB.Height = Height - 2;
            }
            else
            {
                Height = HcbbookTB.Height + 2;
            }
        ...
        {
            HcbbookTB.Location = new Point(8, 10);
            HcbbookTB.Text = String.Empty;
            HcbbookTB.BorderStyle = BorderStyle.None;
            HcbbookTB.TextAlign = HorizontalAlignment.Left;
            HcbbookTB.Font = new Font("Tahoma", 11);
            HcbbookTB.UseSystemPasswordChar = UseSystemPasswordChar;
            HcbbookTB.Multiline = false;
            HcbbookTB.BackColor = Color.FromArgb(66, 76, 85);
            HcbbookTB.ScrollBars = ScrollBars.None;
            HcbbookTB.KeyDown += _OnKeyDown;
            HcbbookTB.Enter += _Enter;
            HcbbookTB.Leave += _Leave;
            HcbbookTB.TextChanged += OnBaseTextChanged;
        }

        public Hcbbook_TextBox()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);

            AddTextBox();
            Controls.Add(HcbbookTB);
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Image == null)
            {
                HcbbookTB.Width = Width - 18;
            }
            else
            {
                HcbbookTB.Width = Width - 45;
            }

            HcbbookTB.TextAlign = TextAlignment;
            HcbbookTB.UseSystemPasswordChar = UseSystemPasswordChar;
    ...
    public class Hcbbook_Panel : ContainerControl
    {

        private GraphicsPath Shape;

        public Hcbbook_Panel()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
    ...
    public class Hcbbook_Separator : Control
    {

        public Hcbbook_Separator()
        {
    ...
    public class Hcbbook_TrackBar : Control
    {
    ...
    public class Hcbbook_NotificationBox : Control
    {
        ...
        public Hcbbook_NotificationBox()
        {
