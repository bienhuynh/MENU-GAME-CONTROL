...
namespace SGP.HCBBOOK.CloudServer.UI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var _userProfile = userService.GetProfile(User.Identity.Name);
        ...
        public ActionResult UploadMyLogo()
        {
            return View();
        }

        [HttpPost]
        public Task<JsonResult> UploadMyLogoAsync()
        {
            try
            {
                foreach (string file in Request.Files)
                {
                    ...
                    if (fileContent != null && fileContent.ContentLength > 0 /*&& fileContent.ContentType == "application/octet-stream"*/)
                    {
                        ...
                        //}
                        string directory = String.Format(@"{0}\{1}", PathUpload.PathUploadLogo, User.Identity.Name.Trim());
                        ...
                        userService.UpdateLogo(User.Identity.Name, String.Format(@"{0}\{1}", User.Identity.Name, fileName));
                        return Task.FromResult(Json("Lưu thành công!"));
                    }
                }
            }
            catch (Exception e)
